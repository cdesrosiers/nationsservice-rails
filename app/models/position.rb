class Position < ActiveRecord::Base
  attr_accessible :name, :description, :location_city, :location_state, 
                  :location_country, :deadline, :logo_path, :position_type,
                  :institution_id, :campus_id, :institution, :campus, :duration,
                  :overview
  ...
  define_index do
    ...
    indexes :name
    indexes :description
    indexes locales.city
    indexes Carmen.country_name(locales.country)
  end
end
